				...
				if ($board['star'] == 1) {?>
				 <tbody>
		            <tr>
		              ...
		              <td onClick = "location.href='php/star_delete.php?uname=<?php echo $board['uname'] ?>'" style='width:120px;'><button type="button" id="btn" class="btn btn-warning"><font size="4">즐삭</font></button></td>
		            </tr>
		        </tbody>
		      <?php }} ?>
        </table>
